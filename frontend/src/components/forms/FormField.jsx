    ...
    return (
        <div>
            ...
            <Field
                ...
                className={
                    "w-full px-2 p-[3px] text-inherit bg-secondary/20 outline-transparent outline-1 focus:outline-primary peer-has-[div]:outline-error/50 rounded text-gray-500 " +
                    className
                }
            />
        </div>
