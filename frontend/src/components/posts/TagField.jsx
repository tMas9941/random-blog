        ...
        <div>
            ...
            <div
                className={` ${
                    tagMessage
                        ? "outline-error/50"
                        : "outline-[gray]/70 outline-transparent focus-within:outline-primary"
                } w-full p-[3px] flex flex-wrap gap-1 items-center flex-wrap  bg-secondary/20  outline-1 rounded-sm `}
            >
                {tags.map((tagName) => (
